...
list_types = {"actuatorfrc", "body", "default", "exclude", "fixed", "geom", "include", "joint", "jointpos", "light",
              "material", "mesh", "motor", "general", "pair", "position", "site", "texture", "touch", "weld"}

float_arg_types = {"@armature", "@axis", "@axisangle", "@coef", "@ctrlrange", "@damping", "@density", "@diaginertia",
                   "@diffuse", "@dir", "@euler", "@force", "@forcerange", "@fovy", "@friction", "@frictionloss",
                   "@fromto", "@gear", "@kp", "@margin", "@markrgb", "@mass", "@polycoef", "@pos", "@quat", "@random",
                   "@range", "@ref", "@reflectance", "@rgb1", "@rgb2", "@rgba", "@scale", "@shininess", "@size",
                   "@solimp", "@solimplimit", "@solref", "@solreflimit", "@specular", "@stiffness", "@timestep",
                   "@transformation"}
